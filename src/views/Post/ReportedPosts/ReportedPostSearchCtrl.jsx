...
import { initSearchValues } from './reportedPostsHelper';

const ReportedPostSearchCtrl = ({ onSearch, onReset }) => {
...
ReportedPostSearchCtrl.propTypes = {
  onSearch: PropTypes.func.isRequired,
  onReset: PropTypes.func.isRequired
};

export default ReportedPostSearchCtrl;

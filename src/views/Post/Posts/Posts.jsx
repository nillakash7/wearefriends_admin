...
import PostSearchCtrl from './PostSearchCtrl';
...
import PartnerTable from './PostTable';
...
const Posts = ({ history, roleID, items, noOfTotalItems, actions }) => {
  // #region Init
  ...
  return (
    <Page className={classes.root} title={title}>
      ...
      <PostSearchCtrl onSearch={onSearchClick} onReset={onResetClick} />
...
function mapDispatchToProps(dispatch) {
  return {
    actions: {
      getPosts: bindActionCreators(pActions.getPosts, dispatch),
